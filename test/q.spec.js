...
describe('$q', function() {
    ...
    it('resolves promise at next digest', function() {
        ...
        expect(promiseSpy).toHaveBeenCalledWith(1738);
    });
    ...
    it('allows chaning handler', function() {
        var d = $q.defer();
    ...
    it('does not modify the original resolution in chains', function() {
        var d = $q.defer();
        var fulfilledSpy = jasmine.createSpy();
    ...
    it('fulfills on chained handler', function() {
        ...
        expect(fulfilledSpy).toHaveBeenCalledWith(1738);
    ...
    it('resolves to original value when nested promise resolved', function() {
        var d = $q.defer();
        var fulfilledSpy = jasmine.createSpy();
        var resolveNested;
    ...
    describe('ES2015 style', function () {
        ...
        it('expects a function as an argument', function () {
            expect($q).toThrow();
            $q(_.noop); // checking to make sure this doesn't throw
        });
    ...
    describe('$$q', function() {
        ...
        it('uses deferreds that do not resolve a digest', function() {
            var d = $$q.defer();
            var fulfilledSpy = jasmine.createSpy();
